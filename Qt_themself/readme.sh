...
"$MyQtDir/configure" -release -static -opensource -nomake examples -nomake tests -confirm-license -ltcg -disable-deprecated-up-to 0x061100 -skip webengine -skip qtwayland -skip qtdoc -skip qtgraphicaleffects -skip qtqa -skip qttranslations -skip qtvirtualkeyboard -skip qtquicktimeline -skip qtquick3d -skip qt3d -skip qtrepotools -skip qttools -skip qtimageformats -skip qtnetworkauth -skip qtwebsockets -skip qtactiveqt -skip qtmacextras -skip winextras -skip qtmultimedia -skip qtgamepad -skip qtserialbus -skip qtspeech -skip qtsensors -skip qtlanguageserver -skip qtdeclarative -skip qtlocation -skip qtsvg -skip qtshadertools -no-ssl -prefix ../build_artifacts_host_powerfull -skip qtserialport -skip qtcharts -system-freetype -- -GNinja -DCMAKE_TOOLCHAIN_FILE="../toolchain_host_powerfull.cmake" && cmake --build . --parallel && cmake --install . && gio trash "$MyQtDir" "$MyQtBaseDir/build_host_powerfull"
